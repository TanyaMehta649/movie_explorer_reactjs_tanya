...
const Success = () => {
  ...
  // This function updates the user plan in localStorage
  const handlePaymentSuccess = () => {
    const userData = localStorage.getItem("user");
    if (userData) {
      const parsedUser = JSON.parse(userData);
      parsedUser.plan = 'premium'; // Set to 'premium' after payment
  ...
  useEffect(() => {
    const verifySubscription = async () => {
      ...
      try {
        ...
        // After verifying the subscription, update the user plan to premium
        setSubscriptionDetails(response.data);
        handlePaymentSuccess(); // Call to update the user's plan to premium
